...
public class NoteEditor : UserControl
{
  ...
  private ToolStripButton openButton, saveButton, imageButton, exportHtmlButton, exportMdButton;
  private ToolStripButton fontButton, colorButton, boldButton, italicButton, underlineButton, highlightButton;
  private ToolStripButton undoButton, redoButton, findNextButton, replaceButton, replaceAllButton;
...
private void HighlightAllMatches(string query)
{
    ...
    editor.SelectAll();
    editor.SelectionBackColor = Color.White; // Clear previous highlights
